...
//This function displays the first image in the slideshow when the page
//loads
var slideIndex= 1;
...
function showSlides(n) {
    var slides=document.getElementsByClassName("mySlides"); //This takes
    //all elements with the class name "mySlides" and stores them
    // in the variable array "slides"
    var dots = document.getElementsByClassName("dot"); //This takes
    //all elements with the class name "dot" and stores them in the 
    //variable array "dots"
    ...
    slides[slideIndex - 1].style.display = "block"; //This displays the image
    //in the slideshow
    dots[slideIndex - 1].className += " active"; //This adds teh active styling to
    //the dot associated with the image
}

//This code will create close the contact form when the user clicks off of it
//Te first step is to add an event listener for any clicks on the website
